...
slimerjs.render = function(task, logger, callback) {
  ...
  var runner = spawn('xvfb-run --auto-servernum --server-num=1 --server-args="-noreset" /home/vagrant/slimerjs-0.9.1/slimerjs /mnt/lib/scripts/screenshot.js ' + task.host + task.pageUrl + ' ' + path, [], {
    cwd: '/home/vagrant',
    env: '/bin/bash'
  });
